        ...
        <div class="row">
         <div class="col-md-8">
          <div class="form-group">
           ...
           <input style="border-color:#5282b2" type="text" id="descricaoServico" name="descricaoServico" value="<?= $servico[0]->descricaoServico ?>" class="form-control" placeholder="Descreva o Serviço" required>
          </div>  
         </div>
        </div>
        <hr>
